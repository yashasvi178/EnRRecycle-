                    ...
                    <div className="row justify-content-center pt-5">
                        <div className="col-md-8">
                            <div className="text-center">
                                ...
                                <p className="section-subtitle pt-3 text-whte">We are happy to provide you with any help if required, to know more please contact us.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-lg-8 bg-white p-5 mt-4 rounded">
                            <div className="custom-form">
                                ...
                                <form method="post"  name="contact-form" id="contact-form">
                                        ...
                                        <div className="row justify-content-center">
                                            <div className="col-md-8">
                                                <p className="text-center submit-terms mb-0 mt-3">Change starts with you.</p>
                                            </div>
                                        </div>
                                    </form>
                            </div>
                        ...
                        <div className="col-md-12">
                            <div className="text-white footer-alt">
                                <div className="float-left">
                                    <p className="copyright-desc pb-0">2021 © ENR. All Rights Reserved</p>
                                </div>
